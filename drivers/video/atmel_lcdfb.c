			     ...
			     struct fb_info *info)
{
	...
	case 16:
		/*
		 * Older products are not supported by this driver: it is not
		 * targetted to Linux upstream as we will move to KMS/DRM
		 */
...
>>>>>>> 7cdc328... video/atmel_lcdfb: add support for AT91SAM9x5
